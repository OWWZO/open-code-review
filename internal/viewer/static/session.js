...
(function() {
    ...
    function updateFilterState() {
        filters.forEach(function(filter) {
            ...
            const isActive = activeValue !== null && activeValue === filter.dataset.filterValue;
    ...
    function renderCommentState(state) {
        ...
        if (emptyState) {
            ...
            if (activeSeverity === null && activeCategory === null) {
                emptyState.textContent = 'Select a severity or category to view findings.';
            } else {
                emptyState.textContent = state.filtered.length === 0 && hiddenByMarks > 0
